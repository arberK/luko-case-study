...
export default function AddInventory() {
  ...
  const handleChoosePhotoSource = () => {
    Alert.alert("Photo source", "Choose the source of the photo?", [
    ...
    <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
      ...
      >
        ...
        <Button
          ...
          color={addDisabled ? "gray" : Colors[colorScheme].tint}
        ></Button>
      </View>
      <ScrollView>
              ...
              <View>
                ...
                <View
                  style={{
                    ...
                    width: DEL_ICON_SIZE,
                    height: DEL_ICON_SIZE,
                    borderRadius: DEL_ICON_SIZE / 2,
                    justifyContent: "center",
                    alignItems: "center",
                  }}
                >
        ...
        ></TextInput>
        {purchasePriceError && (
          <Text style={styles.error}>{purchasePriceError}</Text>
        )}
        ...
        <TextInput
          ...
          style={{ ...styles.txtInputStyle, height: 128 }}
        ></TextInput>
